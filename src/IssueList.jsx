...
class IssueList extends React.Component {
  static async fetchData(match, search, showError) {
    ...
    if (params.get('status')) vars.status = params.get('status'); //query parameter status

    const effortMin = parseInt(params.get('effortMin'), 10); //query parameter effortMin
    if (!Number.isNaN(effortMin)) vars.effortMin = effortMin;
    const effortMax = parseInt(params.get('effortMax'), 10); //query parameter effortMax
    ...
    let page = parseInt(params.get('page'), 10); //query parameter page
  ...
  constructor() {
    ...
    const pages = store.initialData ? store.initialData.issueList.pages : null;
